...
\newcommand{\xmark}{\ding{55}}% kreuzchen
\newcommand{\ok}{\textcolor[rgb]{0.2,0.8,0.2}{\cmark}}
\newcommand{\bad}{\textcolor[rgb]{1,0,0}{\xmark}}
...
\include{einleitung}
\include{funktionen}
\include{hauptteil-android}
\include{hauptteil-qt}
\include{fazit}
