...
\begin{table*}[h]
	\centering
		\begin{tabularx}{\textwidth}{l|l|l|X}
			...
			\hline
			Data & \texttt{0xff} & 12 & Datensatz eines Messpunktes\\
			\hline
		\end{tabularx}
