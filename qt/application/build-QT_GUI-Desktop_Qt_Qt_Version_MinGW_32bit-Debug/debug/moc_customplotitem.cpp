...
#include "../../QT_GUI/customplotitem.h"
...
#define QT_MOC_LITERAL(idx, ofs, len) \
    ...
    qptrdiff(offsetof(qt_meta_stringdata_CustomPlotItem_t, stringdata) + ofs \
...
void *CustomPlotItem::qt_metacast(const char *_clname)
{
    ...
    if (!strcmp(_clname, qt_meta_stringdata_CustomPlotItem.stringdata))
