...
#include "../../QT_GUI/Model/devicemodel.h"
...
#define QT_MOC_LITERAL(idx, ofs, len) \
    ...
    qptrdiff(offsetof(qt_meta_stringdata_DeviceModel_t, stringdata) + ofs \
...
const QMetaObject DeviceModel::staticMetaObject = {
    { &QAbstractListModel::staticMetaObject, qt_meta_stringdata_DeviceModel.data,
      qt_meta_data_DeviceModel,  qt_static_metacall, Q_NULLPTR, Q_NULLPTR}
};
...
void *DeviceModel::qt_metacast(const char *_clname)
{
    ...
    if (!strcmp(_clname, qt_meta_stringdata_DeviceModel.stringdata))
