...
#include "../../QT_GUI/Connection/TcpConnection.h"
...
QT_MOC_LITERAL(6, 67, 12) // "disconnected"
    ...
    "TcpConnection\0error\0\0QTcpSocket::SocketError\0"
...
void TcpConnection::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        {
            typedef void (TcpConnection::*_t)(QTcpSocket::SocketError );
            if (*reinterpret_cast<_t *>(func) == static_cast<_t>(&TcpConnection::error)) {
                *result = 0;
            }
        }
    }
...
// SIGNAL 0
void TcpConnection::error(QTcpSocket::SocketError _t1)
{
