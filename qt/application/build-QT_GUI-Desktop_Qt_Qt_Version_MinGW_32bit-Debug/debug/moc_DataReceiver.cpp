...
#include "../../QT_GUI/Connection/DataReceiver.h"
...
QT_MOC_LITERAL(1, 13, 13), // "updateStorage"
QT_MOC_LITERAL(2, 27, 0), // ""
QT_MOC_LITERAL(3, 28, 15), // "QList<rawData>&"
QT_MOC_LITERAL(4, 44, 19) // "signalizeController"

    },
    "DataReceiver\0updateStorage\0\0QList<rawData>&\0"
    "signalizeController"
};
...
static const uint qt_meta_data_DataReceiver[] = {
 ...
 // signals: parameters
    QMetaType::Void, 0x80000000 | 3, QMetaType::UChar, QMetaType::UChar, QMetaType::UShort,    2,    2,    2,    2,
...
void DataReceiver::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        switch (_id) {
        case 0: _t->updateStorage((*reinterpret_cast< QList<rawData>(*)>(_a[1])),(*reinterpret_cast< quint8(*)>(_a[2])),(*reinterpret_cast< quint8(*)>(_a[3])),(*reinterpret_cast< quint16(*)>(_a[4]))); break;
        case 1: _t->signalizeController((*reinterpret_cast< quint8(*)>(_a[1]))); break;
        default: ;
        }
        ...
        {
            typedef void (DataReceiver::*_t)(QList<rawData> & , quint8 , quint8 , quint16 );
            if (*reinterpret_cast<_t *>(func) == static_cast<_t>(&DataReceiver::updateStorage)) {
                *result = 0;
            }
        }
        {
            typedef void (DataReceiver::*_t)(quint8 );
            if (*reinterpret_cast<_t *>(func) == static_cast<_t>(&DataReceiver::signalizeController)) {
                *result = 1;
            }
        }
    }
...
// SIGNAL 0
void DataReceiver::updateStorage(QList<rawData> & _t1, quint8 _t2, quint8 _t3, quint16 _t4)
{
...
// SIGNAL 1
void DataReceiver::signalizeController(quint8 _t1)
{
